...
$.tzIframe = function(options){
	var opts = $.extend({},$.tzDialog.methods,$.tzDialog.defaults,options);
	var $dialog = opts.init(opts);
	$dialog.find(".tzdialog_message").html("<div  class='tm-dialog-loading tmWindow_loading'><img src='../../resources/sg/images/loading.gif'><label style='font-size:12px;'>请稍后，正在加载中...</label></div>");
...
$.tzDialog.methods = {
	...
	template : function(opts){
		...
		"		<a href='javascript:void(0);' class='delete'><i class='fa fa-fw fa-remove'></i></a>"+
