...
(function (window, $, undefined) {
    ...
    */
    ...
    window.tzHighLighter = {
        ...
        * code: 代码
        */
        code: function (lang, theme, code) {
            lang = typeof lang === 'string' ? window.tzHighLighter.langs[lang] : undefined;
            if (!lang) {
                return;
            }
            theme = typeof theme === 'string' ? window.tzHighLighter.themes[theme] : undefined;
            if (!theme) {
                return;
            }
        ...
        */
        getLangArray: function () {
            var arr = [], item;
            for (item in tzHighLighter.langs) {
                arr.push(item);
            }
            return arr;
        },
        ...
        */
        getThemeArray: function () {
            var arr = [],item;
            for (item in tzHighLighter.themes) {
                arr.push(item);
            }
            return arr;
        }
