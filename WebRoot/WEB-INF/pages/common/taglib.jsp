...
<script type="text/javascript" charset="utf-8" src="${basePath }/resources/js/bootstrap.min.js"></script>
...
<script type="text/javascript" charset="utf-8">var basePath="${basePath}";var adminPath="${basePath}/sys";</script>