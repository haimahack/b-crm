			...
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
			        <div class="content">
						...
						<div class="h-channel"><a class="tmui-tips" tip="添加用户" href="javascript:void(0);"><i class="fa fa-fw fa-user-plus"></i></a>&nbsp;&nbsp; 主页 》 用户列表</div>
								...
								<table class="tztab" id="tztab">
									<caption>
										...
										<div class="fr sbtn">
											...
											<a href="javascript:void(0);" onclick="tzAdmin.search(this)" class="tmui-tips" tip="搜索"><i class="fa fa-fw fa-search-plus"></i></a>
										</div>
									</caption>
									<thead>
										<tr>
